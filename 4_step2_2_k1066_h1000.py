...
output_folder = '4_k1066_h1000_step2-2'
...
for collision_type in collision_types:
  ...
  filename = output_folder+'/4_knots_ids_k'+str(k)+'.pkl'
  ...
  try:
    filename = '2_modelling_results_nospeed_lanes-k1066_h1000_diffferent_kernel'+f'/2_K_weighted_k{k}_h{h}_{kernel_function}.pkl'
    with open(filename, 'rb') as f:
      K_weighted = pickle.load(f)
    print('Here, find existing K_weighted')
    print("✅ Kernel matrix shape:", K_weighted.shape)

    filename = output_folder+f'/4_K_weighted_k{k}_h{h}_{kernel_function}.pkl'
    with open(filename, 'wb') as f:
  ...
  df_model = pd.read_csv(f'/content/5_step1_k1066_h1000_diffferent_kernel/5_summary_stats_k{k}_h{h}_{collision_type}_{kernel_function}.csv')
  ...
  summary_stats.to_csv(output_folder+f'/4_summary_stats_k{k}_h{h}_{collision_type}_{kernel_function}.csv')
  print(summary_stats)